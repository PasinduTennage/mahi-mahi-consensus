...
do
    ...
    scp -i ${cert} experiments/python/async_network.py "${replicas[${index}]}":"${remote_home_path}"
...
nohup ssh "${replica1}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 0 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-0.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v0.log.ansi &
nohup ssh "${replica2}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 1 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-1.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v1.log.ansi &
nohup ssh "${replica3}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 2 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-2.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v2.log.ansi &
nohup ssh "${replica4}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 3 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-3.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v3.log.ansi &
nohup ssh "${replica5}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 4 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-4.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v4.log.ansi &
nohup ssh "${replica6}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 5 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-5.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v5.log.ansi &
nohup ssh "${replica7}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 6 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-6.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v6.log.ansi &
nohup ssh "${replica8}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 7 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-7.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v7.log.ansi &
nohup ssh "${replica9}"   -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 8 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-8.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v8.log.ansi &
nohup ssh "${replica10}"  -i ${cert}   "export RUST_LOG=debug,mysticeti_core::consensus=debug,mysticeti_core::net_sync=debug,mysticeti_core::core=debug; .${remote_replica_path} run --authority 9 --committee-path ${remote_home_path}committee.yaml --public-config-path ${remote_home_path}public-config.yaml --private-config-path ${remote_home_path}private-config-9.yaml --client-parameters-path ${remote_home_path}client-parameters.yml" >${local_output_path}v9.log.ansi &

sleep 10

nohup ssh "${replica1}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack0.log &
nohup ssh "${replica2}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack1.log &
nohup ssh "${replica3}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack2.log &
nohup ssh "${replica4}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack3.log &
nohup ssh "${replica5}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack4.log &
nohup ssh "${replica6}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack5.log &
nohup ssh "${replica7}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack6.log &
nohup ssh "${replica8}"    -i ${cert}   "python3 ${remote_home_path}async_network.py --attack_level 10 --duration 120  --device  ens5" >${local_output_path}attack7.log &
