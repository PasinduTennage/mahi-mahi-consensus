...
python3 scripts/block-create-test.py    ${local_output_path}v0.log.ansi ${local_output_path}v1.log.ansi ${local_output_path}v2.log.ansi ${local_output_path}v3.log.ansi ${local_output_path}v4.log.ansi  ${local_output_path}v5.log.ansi  ${local_output_path}v6.log.ansi  ${local_output_path}v7.log.ansi  ${local_output_path}v8.log.ansi  ${local_output_path}v9.log.ansi
python3 scripts/commit-test.py          ${local_output_path}v0.log.ansi ${local_output_path}v1.log.ansi ${local_output_path}v2.log.ansi ${local_output_path}v3.log.ansi ${local_output_path}v4.log.ansi  ${local_output_path}v5.log.ansi  ${local_output_path}v6.log.ansi  ${local_output_path}v7.log.ansi  ${local_output_path}v8.log.ansi  ${local_output_path}v9.log.ansi
python3 scripts/simple-commit-count.py  ${local_output_path}v0.log.ansi ${local_output_path}v1.log.ansi ${local_output_path}v2.log.ansi ${local_output_path}v3.log.ansi ${local_output_path}v4.log.ansi  ${local_output_path}v5.log.ansi  ${local_output_path}v6.log.ansi  ${local_output_path}v7.log.ansi  ${local_output_path}v8.log.ansi  ${local_output_path}v9.log.ansi